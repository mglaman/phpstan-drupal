...
export const hover = hoverTooltip((view, pos, side) => {
    const currentErrors = view.state.facet(errorsFacet);
    ...
    return {
        ...
        create() {
            ...
            dom.className = 'md:w-[40rem] rounded-lg px-3 py-1 border-0 text-xs flex flex-col gap-2 ' + style;

            const outerDom = document.createElement('div');
            outerDom.className = 'pb-1 bg-transparent';
